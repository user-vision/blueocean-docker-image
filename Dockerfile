...
RUN apt-get update && apt-get install -y wget pandoc pandoc-citeproc gmp libffi zlib pcre R R-dev curl openssl-dev curl-dev gcc g++ git coreutils libxml2-dev cmark git curl zip && rm -rf /var/lib/apt/lists/*
